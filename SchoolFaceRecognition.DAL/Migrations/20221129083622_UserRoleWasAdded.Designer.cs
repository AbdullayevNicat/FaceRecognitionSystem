...
namespace SchoolFaceRecognition.DAL.Migrations
{
    ...
    [Migration("20221129083622_UserRoleWasAdded")]
    partial class UserRoleWasAdded
    {
            ...
            modelBuilder.Entity("SchoolFaceRecognition.Core.Entities.Auth.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreaterUser = "Admin",
                            CreationDate = new DateTime(2022, 11, 29, 12, 36, 22, 541, DateTimeKind.Local).AddTicks(480),
                            IsDeleted = false,
                            Name = "Teacher"
                        },
                        new
                        {
                            Id = 2,
                            CreaterUser = "Admin",
                            CreationDate = new DateTime(2022, 11, 29, 12, 36, 22, 541, DateTimeKind.Local).AddTicks(541),
                            IsDeleted = false,
                            Name = "Director"
                        },
                        new
                        {
                            Id = 3,
                            CreaterUser = "Admin",
                            CreationDate = new DateTime(2022, 11, 29, 12, 36, 22, 541, DateTimeKind.Local).AddTicks(543),
                            IsDeleted = false,
                            Name = "Admin"
                        });
                });
