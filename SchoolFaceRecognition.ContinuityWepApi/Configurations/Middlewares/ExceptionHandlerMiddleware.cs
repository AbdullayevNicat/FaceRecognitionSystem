...
namespace SchoolFaceRecognition.ContinuityWebAPI.Configurations.Middlewares
{
    public class ExceptionHandlerMiddleware
    {
        ...
        private async Task HandleExceptionAsync(HttpContext httpContext, Exception exception)
        {
            ...
            {
                await WriteToResponseAsync(httpContext, httpStatusCode, ConstantLiterals.UserInternalErrorMessage);
            }
            else
            {
